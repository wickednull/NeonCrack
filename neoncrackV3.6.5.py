#!/usr/bin/env python3
"""
NeonCrack v3.6.5 – cyber-punk Wi-Fi & network toolkit
─────────────────────────────────────────────────────
...
NEW in v3.6.5
─────────────
• Killer toggle (🛠 Utilities) — systemctl-stops NetworkManager, wpa_supplicant
  and ModemManager so nothing steals your NIC during attacks.
"""
...
root = Tk(); root.title("NeonCrack v3.6.5"); root.configure(bg=BGC); root.geometry("1080x850")
